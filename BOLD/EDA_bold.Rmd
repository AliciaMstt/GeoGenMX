...
```{r prov_kin_plot, echo=FALSE, warning=FALSE}
prov_kin_plot
```
...
```{r reg_kin_plot, echo=FALSE, warning=FALSE}
reg_kin_plot
```
...
```{r sec_kin_plot, echo=FALSE, warning=FALSE}
sec_kin_plot
```
...
```{r exsit_kin_plot, echo=FALSE, warning=FALSE}
exsit_kin_plot
```
