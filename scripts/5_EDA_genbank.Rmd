...
#modify plot to lollipop plot add donut plot
```{r, echo=FALSE, warning=FALSE, message=FALSE}
library(ggplot2) 
kingplot<-ggplot(data=king_phyl, aes(x=kingdom, y=num_seqs, fill=kingdom))+
           geom_bar(stat="identity")+theme(axis.text.x=element_text(angle=90)) + ggtitle("") + xlab("Kingdom") + ylab("Number of sequences") 
