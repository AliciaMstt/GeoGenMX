...
```{r}
phylumid_kingdom[44,]<-c(NA, "Zygomycota", "Fungi")
phylumid_kingdom[45,]<-c(NA, "Pteridophyta", "Viridiplantae")
phylumid_kingdom[46,]<-c(NA, "Magnoliophyta", "Viridiplantae")
phylumid_kingdom[47,]<-c(NA, "Pinophyta", "Viridiplantae")
phylumid_kingdom[48,]<-c(NA, "Heterokontophyta", "Protista")
phylumid_kingdom[49,]<-c(NA, "Cryptophyta", "Protista")
phylumid_kingdom[50,]<-c(NA, "Pyrrophycophyta", "Protista")
phylumid_kingdom[51,]<-c(NA, "Marine", NA)
