...
library(readr)
genbank<-read_csv("../data/genbank/infotax_ncbi.csv")
bold<-read_csv("../data/bold/taxinfo_bold.csv")
...
all_species<-rbind( cbind (bold_ingb[,-9], gb_inbold[match(bold_ingb$species_name, gb_inbold$species_name ), 1] ), bold_nogb, gb_genus, gb_subfamily, gb_family, gb_order, gb_class )
